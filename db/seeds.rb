...
onePiecePhoto = open('https://soggyroll-dev.s3-us-west-1.amazonaws.com/soggyroll_images/onePiecePic.jpeg')
onePiece.anime.attach(io: file, filename: 'onePiecePic.jpeg')

...
# episodes
opEp1 = Episode.create!(title: 'I’m Luffy! The Man Who’s Gonna Be King of the Pirates!', description: 'Countless souls have been lured along the Grand Line in pursuit of the legendary One Piece! Luffy D. Monkey is a young pirate with a dream: to prove the legend true and be king of them all!', video_id: 1)
